//gcc main.c calcs/help.c calcs/Science-calc.c calcs/algebra.c electrics-c/electrical-laws.c electrics-c/initLaws.c electrics-c/AC-basics.c electrics-c/RLC_circuits/Series.c electrics-c/RLC_circuits/Parallel.c electrics-c/check_input.c -o mycalc
